        ...
        <div className="signup">
            <div className="signup-container">
                <div className="signup-heading">
                    ...
                    {generalError && <p style={{ color: "red", paddingBottom: "6px", textAlign: "center", fontSize: "13px", fontFamily: "var(--p-font)" }}>{generalError}</p>}
                </div>
                <form className="form" onSubmit={handleSubmit}>
                    ...
                    <div className="google-signin">
                        ...
                        <div>
                            <p style={{ fontSize: "12px", lineHeight: "150%", fontFamily: "var(--p-font)", textAlign: "center", paddingTop: "12px" }}>
                            ...
                            <p style={{ fontSize: "14px", fontFamily: "var(--p-font)", textAlign: "center", paddingTop: "12px" }}>
