...
//                             }}
//                         />
//                         <div className="forgot-password" style={{ width: "100%", display: "flex", justifyContent: "end", fontSize: "12px", fontFamily: "var(--p-font)", paddingTop: "6px" }}>
...
//                         <p style={{ fontFamily: "var(--p-font)", fontSize: "13px", paddingTop: "16px", textAlign: "center" }}>Dont have an account? <Link href="/signup">Sign up</Link></p>
//                     </div>
//                 </form>
//             </div>
//         </div>
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // You can handle post-login logic here, such as redirecting the user
    ...
    const handleGoogleSignIn = async () => {
        try {
            ...
            // Handle post-login logic with Google authentication here
        ...
        <div className="login">
            <div className="login-container">
                ...
                <form className="form" onSubmit={handleSubmit}>
                    ...
                    <div className="google-signin">
                        <button type="button" className="login-with-google-btn" onClick={handleGoogleSignIn}>Login with Google</button>
                        <p style={{ fontFamily: "var(--p-font)", fontSize: "13px", paddingTop: "16px", textAlign: "center" }}>Don&apos;t have an account? <Link href="/signup">Sign up</Link></p>
                    </div>
                </form>
            </div>
        </div>
